console.log("server.js began")

try {
    var express = require('express')
} catch (error) {
    console.log("there was an error importing package url. Run 'npm install express' to install package")
    console.log("Type 'npm list' to see what packages have been installed.")
    throw new Error('package express not installed');
}

try {
    var url = require('url')
} catch (error) {
    console.log("there was an error importing package url. Run 'npm install url' to install package")
    console.log("Type 'npm list' to see what packages have been installed.")
    throw new Error('package url not installed');
}

try {
    var fs = require('fs')
} catch (error) {
    console.log("there was an error importing package fs. Run 'npm install fs' to install package")
    console.log("Type 'npm list' to see what packages have been installed.")
    throw new Error('package fs not installed');
}
